...
def calculate_remaining_angle(angle_1, angle_2):
...
angle_rads = []
for deg in angles:
    angle_rads.append(degree_to_radian(int(deg)))


# Must have at least one side given
side_a_adjacent = 0
side_b_opposite = 0
side_c_hypotenuse = 0

# Must have at least one angle given
angle_a = 0
angle_b = 0
angle_c = 0
...
# colors = ['m', 'g', 'r', 'b']
#
# # TODO: make length of axes dependent on input lengths
